...
public class MerkleTreePathTest {
    ...
    public void testShouldVerifyInclusionProof() {
        MerkleTreePath path = new MerkleTreePath(
                DataHash.fromImprint(HexConverter.decode("00001fd5fffc41e26f249d04e435b71dbe86d079711131671ed54431a5e117291b42")),
                List.of(
                        new MerkleTreePathStep(
        ...
        Assertions.assertEquals(new MerkleTreePathVerificationResult(true, true), path.verify(BigInteger.valueOf(0b100000000)));
        Assertions.assertEquals(new MerkleTreePathVerificationResult(true, false), path.verify(BigInteger.valueOf(0b100)));
    }

    @Test
    public void testShouldVerifyNonInclusionProof() {
        MerkleTreePath path = new MerkleTreePath(
                DataHash.fromImprint(HexConverter.decode("000096a296d224f285c67bee93c30f8a309157f0daa35dc5b87e410b78630a09cfc7")),
                List.of(
                        new MerkleTreePathStep(
                                BigInteger.valueOf(16),
                                DataHash.fromImprint(HexConverter.decode("00006c5ad75422175395b4b63390e9dea5d0a39017f4750b78cc4b89ac6451265345")),
        ...
        Assertions.assertEquals(new MerkleTreePathVerificationResult(true, false), path.verify(BigInteger.valueOf(0b1000000)));
    }
