...
/**
 * DataHasher is a utility class for hashing data using a specified hash algorithm. It provides
 * methods to update the hash with data and to retrieve the final hash.
 */
