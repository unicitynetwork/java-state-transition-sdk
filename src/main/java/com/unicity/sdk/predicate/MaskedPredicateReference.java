...
public class MaskedPredicateReference implements IPredicateReference {
    ...
    public static MaskedPredicateReference create(TokenType tokenType, String signingAlgorithm, byte[] publicKey, HashAlgorithm hashAlgorithm, byte[] nonce) throws JsonProcessingException {
        ArrayNode node = UnicityObjectMapper.CBOR.createArrayNode();
        node.add(PredicateType.MASKED.getType());
