...
public class MaskedPredicateJson {
  ...
  public static class Deserializer extends
    ...
    public MaskedPredicate deserialize(JsonParser p, DeserializationContext ctx)
      ...
      if (!p.isExpectedStartObjectToken()) {
        throw MismatchedInputException.from(p, MaskedPredicate.class, "Expected object value");
      }
      ...
      while (p.nextToken() != JsonToken.END_OBJECT) {
        ...
        try {
          ...
          throw MismatchedInputException.wrapWithPath(e, MaskedPredicate.class, fieldName);
        }
      }
      ...
      return new MaskedPredicate(publicKey, algorithm, hashAlgorithm, nonce);
    }
  }
}
