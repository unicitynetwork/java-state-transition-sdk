...
public class InclusionProof {
    ...
    public InclusionProofVerificationStatus verify(RequestId requestId) {
        if (authenticator != null && transactionHash != null) {
            ...
            try {
                ...
                if (step == null || step.getBranch() == null || leafValue.equals(step.getBranch().getValue())) {
        ...
        MerkleTreePathVerificationResult result = this.merkleTreePath.verify(requestId.toBitString().toBigInteger());
    ...
    public boolean equals(Object o) {
        if (!(o instanceof InclusionProof)) return false;
        InclusionProof that = (InclusionProof) o;
        return Objects.equals(merkleTreePath, that.merkleTreePath) && Objects.equals(authenticator, that.authenticator) && Objects.equals(transactionHash, that.transactionHash);
    }
