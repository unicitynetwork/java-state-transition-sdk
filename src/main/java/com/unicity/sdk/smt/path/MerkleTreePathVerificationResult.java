...
public class MerkleTreePathVerificationResult {
    ...
    public String toString() {
        return String.format("MerkleTreePathVerificationResult{pathValid=%b, pathIncluded=%b}",pathValid, pathIncluded);
    }

    @Override
    public boolean equals(Object o) {
        if (!(o instanceof MerkleTreePathVerificationResult)) return false;
