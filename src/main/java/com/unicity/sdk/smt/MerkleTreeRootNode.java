...
public class MerkleTreeRootNode {
  ...
  public static MerkleTreeRootNode create(FinalizedBranch left, FinalizedBranch right,
  ...
  public MerkleTreePath getPath(BigInteger path) {
    return new MerkleTreePath(this.rootHash,
        MerkleTreeRootNode.generatePath(path, this.left, this.right));
  }

  @Override
  public boolean equals(Object o) {
    if (!(o instanceof MerkleTreeRootNode)) {
      return false;
    }
    ...
    return Objects.equals(path, that.path) && Objects.equals(left, that.left) && Objects.equals(
        right, that.right) && Objects.equals(rootHash, that.rootHash);
  }
  ...
  private static List<MerkleTreePathStep> generatePath(
    ...
    if (branch == null) {
      return List.of(
          new MerkleTreePathStep(remainingPath, siblingBranch, (FinalizedLeafBranch) null));
    }
    ...
    if (branch.getPath().equals(commonPath.getPath())) {
      ...
      return Stream.concat(
          MerkleTreeRootNode.generatePath(remainingPath.shiftRight(commonPath.getLength()),
